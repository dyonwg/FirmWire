...
const char TASK_NAME[] = "AFL_RRCSEQ\0";
...
void fuzz_single()
{
    ...
    while(offset + 3 < size)
    {
        ...
        memcpy(asn_pl, buf+offset, cur_msg_len);
        item->pl_ptr = asn_pl;
